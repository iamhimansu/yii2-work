...
class ExcelXlsxWriter extends Xlsx
{
    /**
    ...
    public function stream($filename, $content = [])
    {
        $this->processFlags(0);
        ...
        $this->stringTable = [];
//        $i = 0;
//        while ($i < $this->spreadSheet->getSheetCount()) {
...
//
//        if (!empty($content)){
//           $zipContent = $content['xl/worksheets/sheet1.xml'] ?? [];
//        }
